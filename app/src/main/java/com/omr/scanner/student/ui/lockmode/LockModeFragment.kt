...
import com.omr.scanner.student.databinding.FragmentLockModeBinding
...
class LockModeFragment : Fragment() {
    ...
    override fun onPause() {
        super.onPause()
        if (!allowNavigation && sessionId.isNotBlank()) {
            viewModel.logViolation("switch_app", mapOf("screen" to "lock_mode"))
        }
    }
