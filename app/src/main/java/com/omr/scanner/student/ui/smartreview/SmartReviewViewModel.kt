package com.omr.scanner.student.ui.smartreview
...
import com.omr.scanner.student.model.request.IdZoneResultRequest
import com.omr.scanner.student.model.request.StudentAnswerRequest
...
class SmartReviewViewModel(
    ...
    fun saveResults(totalScore: Double, examId: String, studentId: String) {
        ...
        if (rawImageBase64.isBlank() || processedImageBase64.isBlank()) {
