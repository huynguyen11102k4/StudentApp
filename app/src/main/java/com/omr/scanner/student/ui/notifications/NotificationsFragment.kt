...
import com.omr.scanner.student.databinding.FragmentNotificationsBinding
...
class NotificationsFragment : Fragment() {
    ...
    private fun handleNotificationClick(notification: com.omr.scanner.student.data.model.AppNotification) {
