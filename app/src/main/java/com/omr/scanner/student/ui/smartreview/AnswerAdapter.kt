...
import com.omr.scanner.student.databinding.ItemAnswerBinding
    ...
    class ViewHolder(private val binding: ItemAnswerBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(answer: Answer, onEditClick: (Answer) -> Unit) {
            ...
            binding.ivStatusIcon.setImageResource(
                when (answer.status) {
                    "correct" -> com.omr.scanner.student.R.drawable.ic_check
                    "wrong" -> com.omr.scanner.student.R.drawable.ic_close
                    else -> com.omr.scanner.student.R.drawable.ic_check
                }
            )
