package com.omr.scanner.student.omr

import android.graphics.Bitmap
import android.util.Log
import com.google.gson.Gson
import com.google.gson.JsonElement
import com.omr.scanner.student.OmrEngine
import com.omr.scanner.student.OmrEngineOptions
import com.omr.scanner.student.data.model.Answer
import com.omr.scanner.student.model.response.AnswerKeysResponse
...
class OmrProcessor(
    ...
    private fun validateIdZone(idResult: com.omr.scanner.student.IdResult, enabledFields: EnabledIdFields) {
    ...
    private fun isEnabledIdResultReadable(
        idResult: com.omr.scanner.student.IdResult,
